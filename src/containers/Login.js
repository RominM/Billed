...
export default class Login {
  ...
  handleSubmitAdmin(e) {
    const user = {
      type: "Admin",
      email: e.target.querySelector(`input[data-testid="admin-email-input"]`).value,// error : employee-email
      password: e.target.querySelector(`input[data-testid="admin-password-input"]`).value,// error : employee-employee-password
      status: "connected"
    };
